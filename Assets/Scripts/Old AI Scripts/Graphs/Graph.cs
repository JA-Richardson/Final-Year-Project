...
public class Graph
{
    ...
    {
        PathNode from = findNode(fromNode);
        PathNode to = findNode(toNode);
    ...
    PathNode findNode(GameObject id)
    {
    ...
    {
        PathNode start = findNode(startId);
        PathNode end = findNode(endId);
    ...
    public void reconstructPath(PathNode startId, PathNode endId)
    {
        pathList.Clear();
        pathList.Add(endId);
    ...
    float distance(PathNode a, PathNode b)
    {
